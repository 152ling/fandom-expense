 ...
 */
        ...
        function renderFAQView(container) { 
            const faqs = [
                ...
                { key_q: "faq_q7", q: "如何修改已建立的資料或標籤？", key_a: "faq_a7", a: "點擊商品卡片右上角的...按鈕後，會跳出彈窗選擇「編輯資料」即可進行修改；若要修改已建立的 tag，可以直接在編輯時刪除舊標籤、輸入並新增正確的 tag 後儲存即可。" },
                { key_q: "faq_q8", q: "如果數量下拉選單的數字不夠用怎麼辦？", key_a: "faq_a8", a: "數量欄位除了可以透過選單快速點選之外，也可以直接點擊該數量輸入框，會跳出數字鍵盤讓你自己輸入想要的數量！" }
            ];
